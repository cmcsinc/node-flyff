...
- [ ] Task 7: CPlayer m_aJobSkill + serializer wire + join.service hydration
- [ ] Task 8: combat/skillFormulas.ts + tables AF_* + tests

## Reference docs
- `docs/skills-research.md` — canonical C++→TS port reference
- `PROGRESS.md` — project ledger
