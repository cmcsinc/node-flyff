...
6. **Manual smoke runbook** — **not done (runtime task).** Boot login/cluster/world with Redis + SQLite, run a scripted TCP client (or a real v19 client) through the slice. Steps:
