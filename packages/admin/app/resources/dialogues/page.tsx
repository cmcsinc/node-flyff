...
export default async function DialoguesPage({ searchParams }: { searchParams: Promise<SearchParams> }): Promise<React.JSX.Element> {
  ...
  const filtered = rows.filter((r) => {
    ...
    if (needle && !r.prefix.toLowerCase().includes(needle) && !r.npcName.toLowerCase().includes(needle))
      return false;
    return true;
  });
