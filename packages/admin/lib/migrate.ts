...
const MIGRATIONS: readonly Migration[] = [
  ...
  // 003 — characters.gold
  {
    column: ['characters', 'gold'],
    sql: [`ALTER TABLE characters ADD COLUMN gold TEXT NOT NULL DEFAULT '0'`],
  },
  // 004 — bank.tab + accounts.bank_gold
  { column: ['bank', 'tab'], sql: [`ALTER TABLE bank ADD COLUMN tab INTEGER NOT NULL DEFAULT 0`] },
  {
    column: ['accounts', 'bank_gold'],
    sql: [`ALTER TABLE accounts ADD COLUMN bank_gold TEXT NOT NULL DEFAULT '0'`],
  },
  // 005 — skills.slot + characters.skill_point/skill_level
  {
    column: ['skills', 'slot'],
    sql: [`ALTER TABLE skills ADD COLUMN slot INTEGER NOT NULL DEFAULT 0`],
  },
  {
    column: ['characters', 'skill_point'],
    sql: [`ALTER TABLE characters ADD COLUMN skill_point INTEGER NOT NULL DEFAULT 0`],
  },
  {
    column: ['characters', 'skill_level'],
    sql: [`ALTER TABLE characters ADD COLUMN skill_level INTEGER NOT NULL DEFAULT 0`],
  },
  // 006 — characters.bank_pass
  {
    column: ['characters', 'bank_pass'],
    sql: [`ALTER TABLE characters ADD COLUMN bank_pass TEXT NOT NULL DEFAULT '0000'`],
  },
  // 007 — characters.angle
  {
    column: ['characters', 'angle'],
    sql: [`ALTER TABLE characters ADD COLUMN angle REAL NOT NULL DEFAULT 0`],
  },
  // 008 — normalize containers (inventory + bank tables)
  {
    column: ['inventory', 'gold'],
    sql: [
      `CREATE TABLE IF NOT EXISTS inventory (
  ...
  { column: ['characters', 'taskbar'], sql: [`ALTER TABLE characters ADD COLUMN taskbar TEXT`] },
  // 010 — characters.remain_gp
  {
    column: ['characters', 'remain_gp'],
    sql: [`ALTER TABLE characters ADD COLUMN remain_gp INTEGER NOT NULL DEFAULT 0`],
  },
  // 011 — bank gold_tab1 / gold_tab2
  {
    column: ['bank', 'gold_tab1'],
    sql: [`ALTER TABLE bank ADD COLUMN gold_tab1 TEXT NOT NULL DEFAULT '0'`],
  },
  {
    column: ['bank', 'gold_tab2'],
    sql: [`ALTER TABLE bank ADD COLUMN gold_tab2 TEXT NOT NULL DEFAULT '0'`],
  },
  // 012 — inventory_item element / element_level
  {
    column: ['inventory_item', 'element'],
    sql: [
  ...
  {
    column: ['characters', 'pk_propensity'],
    sql: [
  ...
  { column: ['characters', 'buffs'], sql: [`ALTER TABLE characters ADD COLUMN buffs TEXT`] },
  ...
  {
    column: ['character_buffs', 'expires_at_ms'],
    sql: [`ALTER TABLE character_buffs ADD COLUMN expires_at_ms INTEGER NOT NULL DEFAULT 0`],
  },
  ...
  {
    dropColumn: ['character_buffs', 'total_ms'],
    sql: [`ALTER TABLE character_buffs DROP COLUMN total_ms`],
  },
  ...
  {
    column: ['characters', 'messenger_state'],
    sql: [`ALTER TABLE characters ADD COLUMN messenger_state INTEGER NOT NULL DEFAULT 0`],
  },
  ...
  {
    column: ['characters', 'campus_point'],
    sql: [
  ...
  {
    column: ['guild', 'win_point'],
    sql: [`ALTER TABLE guild ADD COLUMN win_point INTEGER NOT NULL DEFAULT 0`],
  },
  ...
  for (const m of MIGRATIONS) {
    ...
    const label = m.dropColumn
      ...
      : m.column
        ...
        : m.table ?? '(unknown)';
    console.warn(`[admin/migrate] ${label} missing — applying migration`);
