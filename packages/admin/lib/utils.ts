...
const WORLD_IDS: Record<number, string> = {
  ...
  4: "RARTESIA",
  5: "DARKRARTESIA",
  21: "HEAVEN01", 22: "HEAVEN02", 23: "HEAVEN03", 24: "HEAVEN04", 25: "HEAVEN05",
  100: "0425", 101: "TEST", 102: "LUX", 103: "LUX2",
  120: "EVENT01",
  202: "GUILDWAR", 203: "VOLCANE",
  208: "ARENA", 209: "MINIROOM", 211: "QUIZ",
  231: "COLOSSEUM", 232: "ARENA", 233: "FWC", 234: "MARKET", 235: "RICHCASTLE",
};
...
export function worldName(worldId: string | number | null | undefined): string {
  ...
  return raw.replace(/^WI_(WORLD|INSTANCE|DUNGEON|GUILDHOUSE)_/, "")
    .replace(/^WI_/, "")
    .replace(/_/g, " ")
