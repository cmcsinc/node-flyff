 ...
 *
 * Mirrors `CUser::AddText` (`WORLDSERVER/User.cpp:653`) with `__S_SERVER_UNIFY`
 * OFF (Florist default — no `TEXT_GENERAL` BYTE):
...
import { NULL_ID, SNAPSHOTTYPE_TEXT, TEXT_COLOR_NOTICE } from './constants.js';
