...
import type { RevivalService, RevivalOutcome } from '../../src/services/revival.service.js';
...
describe('RevivalHandler', () => {
  it('delegates to revive on empty body', () => {
    let called = false;
    const svc = { revive: () => { called = true; return { ok: true }; } } as unknown as RevivalService;
