 ...
 *
 * Pins the equip-confirm snapshot. The #1 equip wire risk is EQUIP_INFO:
 ...
 * stream desyncs (nPart reads garbage) and Neuz crashes.
 *
 * Vicinity (`User.cpp:4515`): 38 B -- objid + 0x0006 + nId + idGuild + fEquip
 * + EQUIP_INFO(12) + nPart. Sent to self + peers (one format).
 */
