 ...
 *   CObj:            1+4+2+12+2       = 21
 *   CCtrl:           4                =  4
 *   CItemBase:       4+4+8+4          = 20  (serial QWORD + empty String DWORD)
 *   CItemElem:       2+2+4+2+1+4+4+1+4+4+12+1+8+4+1+1 = 55
 *   per-entry total: 11+21+4+20+55    = 111
 *   1-entry packet:  10 (header) + 111 = 121
 */
